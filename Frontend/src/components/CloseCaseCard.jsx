    ...
    return (
        <div className="bg-white shadow-md rounded-2xl p-4 flex flex-col items-center justify-center w-full h-[200px] sm:w-[250px] sm:h-[220px] md:w-[300px] md:h-[250px]">
            <div className="flex items-center space-x-2 mb-2">
                ...
                <h2 className="text-lg font-bold text-gray-800 sm:text-xl md:text-2xl">Closed Cases</h2>
            </div>
            <p className="text-2xl font-semibold text-green-600 sm:text-3xl md:text-4xl">{count}</p>
        </div>
    );
};
