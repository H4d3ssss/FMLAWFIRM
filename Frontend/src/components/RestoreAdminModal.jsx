        ...
        <div className="p-6">
          <div className="flex items-center mb-4">
            ...
            <p className="text-gray-700 text-sm">
              Are you sure you want to restore admin{" "}
              <span className="font-bold">{adminData.name}</span>? This will
              move them back to the active admin list.
            </p>
          </div>
          ...
          <div className="flex justify-end space-x-4 mt-6">
            ...
            <button
              ...
              onClick={() => {
                handleRestore1(adminData.lawyer_id);
                closeModal();
              }}
            >
              Restore Admin
