    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center py-4 space-y-4">
                <Link
                    to="/client-dashboard"
                    className={`flex items-center justify-center w-full p-2 rounded-lg transition-colors ${isActive("/client-dashboard") ? "bg-[#E68900]" : "hover:bg-[#E68900]"
                        }`}
                >
                ...
                <Link
                    ...
                    className={`flex items-center justify-center w-full p-2 rounded-lg transition-colors ${isActive("/client-appointment") ? "bg-[#E68900]" : "hover:bg-[#E68900]"
                        }`}
                >
                ...
                <Link
                    to="/client-cases"
                    className={`flex items-center justify-center w-full p-2 rounded-lg transition-colors ${isActive("/client-cases") ? "bg-[#E68900]" : "hover:bg-[#E68900]"
                        }`}
                >
