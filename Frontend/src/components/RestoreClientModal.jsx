...
const RestoreClientModal = ({ showModal, closeModal, clientData, handleRestoreClient }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-8 max-w-md w-full">
                ...
                <p className="mb-6">
                    Are you sure you want to restore client {clientData.first_name} {clientData.last_name}?
