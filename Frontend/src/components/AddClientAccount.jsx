...
const AddClientAccount = ({ showModal, closeModal, refreshTables, getNextClientId }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Dynamic logic: Send data to the backend (commented out for now)
        /*
        try {
            const response = await axios.post(
                "http://localhost:3000/api/clients/add-account", // Backend endpoint
                { clientAccountData, adminClientData }
            );
                ...
                <div className="p-6">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium">House/Block No.*</label>
                                <input
                                    type="text"
                                    name="houseNumber"
