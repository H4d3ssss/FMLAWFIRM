...
const ArchiveCaseModal = ({ showModal, closeModal, caseDetails, handleArchive }) => {
    if (!showModal || !caseDetails) return null; // Do not render the modal if it's not visible or caseDetails is missing

    const onArchive = () => {
        handleArchive(caseDetails); // Pass the case to the archive handler
            ...
            <div className="bg-white rounded-lg w-full max-w-md shadow-lg relative">
                ...
                <div className="p-6">
                    <p className="mb-4 text-gray-700">
                        Are you sure you want to archive the following case? This action cannot be undone.
                    </p>
                    <div className="mb-4">
