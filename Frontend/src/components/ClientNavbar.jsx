...
const ClientNavbar = () => {
    ...
    useEffect(() => {
        ...
        const fetchClientInfo = async () => {
            try {
                const response = await axios.get('http://localhost:3000/api/auth/authenticate-user', {
                ...
                if (response.data && response.data.role === 'Client') {
                    ...
                    // Fetch client cases
                    const casesResponse = await axios.get(`http://localhost:3000/api/clients/${response.data.clientId}/cases`, {
                        withCredentials: true
                    });
    ...
    const handleSearch = (query) => {
        ...
        const filteredResults = clientCases.filter((caseItem) =>
