    ...
    >
      ...
      <div className="flex flex-col items-center py-4 space-y-4">
        ...
        >
          ...
          {isHovered && (
            <span className="ml-4 text-sm font-medium">Calendar</span>
          )}
        </Link>
        ...
        >
          ...
          {isHovered && (
            <span className="ml-4 text-sm font-medium">Clients</span>
          )}
        </Link>
        ...
        >
          ...
          {isHovered && (
            <span className="ml-4 text-sm font-medium">Accounts</span>
          )}
        </Link>
        ...
        >
          ...
          {isHovered && (
            <span className="ml-4 text-sm font-medium">Archive</span>
          )}
        </Link>
      </div>
    </div>
