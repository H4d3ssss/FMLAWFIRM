...
function RegisterForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            birth_date: formData.birthDate,  // Include birthDate in payload
            age: formData.age,
            sex: formData.sex,
        ...
        try {
            ...
            setServerMessage(res.ok ? 'Account created!' : data.error || 'Something went wrong.');
        } catch (err) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4 py-12">
            ...
            >
                ...
                <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                            By creating an account, you agree to abide by the firm's data privacy policies and security
                            protocols. You acknowledge that all case files and client information accessed through this
                            system are confidential and must not be shared, altered, or used without proper authorization.
                            Unauthorized access or misuse of this system may result in legal action and account suspension.
                        </p>
                ...
                {/* Server Message */}
                {serverMessage && (
                    <p className={`text-center text-sm ${serverMessage.includes('created') ? 'text-green-600' : 'text-red-600'}`}>
                        {serverMessage}
                    </p>
                )}
                ...
                <button
                    type="submit"
                    className={`w-full py-2 rounded-md transition ${isLoading ? 'bg-gray-400 cursor-not-allowed' : 'bg-indigo-600 text-white hover:bg-indigo-700'}`}
                    disabled={isLoading}
                >
