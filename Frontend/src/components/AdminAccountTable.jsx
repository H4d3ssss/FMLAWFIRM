...
const AdminAccountTable = ({ admins }) => {
    ...
    const handleArchiveAdmin = (admin) => {
                    ...
                    <tbody>
                        {paginatedAdmins.map((admin) => (
                            <tr key={admin.id} className="odd:bg-white even:bg-gray-100">
                                <td className="p-3 text-center">{admin.id}</td> {/* Display Admin ID */}
                                <td className="p-3 text-center">{admin.name}</td>
                                <td className="p-3 text-center">{admin.email}</td>
                                <td className="p-3 text-center">************</td>
                                <td className="p-3 text-center">
                                    <span
                                        className={`px-2 py-1 rounded ${admin.status === "Active"
                                ...
                                <td className="p-3 text-center flex justify-center space-x-2">
                                    ...
                                    <button onClick={() => handleArchiveClick(admin)}>
